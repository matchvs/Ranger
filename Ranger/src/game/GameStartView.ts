...
class GameStartView extends egret.Sprite {
    ...
    private initView(): void {
        ...
        // var leaveBtn: MyButtonForGame = new MyButtonForGame("startBtnImage", "startBtnImage");
        // this.addChild(leaveBtn);
        // leaveBtn.x = Const.SCENT_WIDTH / 2 - leaveBtn.width / 2;
        // leaveBtn.y = Const.SCENT_HEIGHT - leaveBtn.height - 30;
        // leaveBtn.setClick(this.onLeaveGameHandler.bind(this));
